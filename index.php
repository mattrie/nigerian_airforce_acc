            ...
            function fn_resize($image_resource_id,$width,$height) {
                    ...
                    return $target_layer;
                             ...
                             if(isset($_POST['Submit'])){
                              // By  Adedokun Adewale Azeez 19th October 2019
  ...
  <header id="header">
      ...
      <div class="logo float-left">
        <h3 class="text-light"><a href="index.php"><span><b>
         <img src="images/1200px-Nigerian_Air_Force_emblem.svg.png" style="width: 40px;" alt="">   SEAFB (RDCSAC)</b></span></a></h3>
          ...
          <div class="carousel-item active" style="background-image: url('assets1/img/slide/naf_slide.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                <h2 class="animate__animated animate__fadeInDown"><span> Sam Ethnan <br> Air Force Base <br> SEAFB (RDCSAC)</span></h2>
          ...
          <div class="carousel-item" style="background-image: url('assets1/img/slide/naf_slide4.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                ...
                <p class="animate__animated animate__fadeInUp">With real-time updates and customizable features, adapting to the dynamic nature of Air Force operations, ensuring accurate tracking and allocation of accommodations across various bases and deployments to improve communication, and enhance the quality of life for service members and their families.</p>
             <!-- <a href="#"  class="btn btn-success  btn-round-full text-white animation" id="menu2" data-toggle="modal" data-target="#myModal" ><b>Register For A Loan </b></a> -->
            </div>
            </div>
          </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center about-content">
            ...
            <div class="section-title">
              <h2>About Us</h2>
              <p style="text-align: justify">At SEAFB (RDCSAC), we are dedicated to providing cutting-edge solutions for accommodation management in Air Force Barracks. With a team of passionate professionals, we strive to revolutionize the way military housing logistics are handled, ensuring efficiency, transparency, and ease of use for Air Force personnel and their families. Our innovative software is designed with the unique needs of the military in mind, offering intuitive interfaces and unparalleled support to enhance the quality of life and readiness of our service members.</p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="bx bx-fingerprint"></i></div>
              <h4 class="title"><a href="">Mission</a></h4>
              <p class="description">Our mission is to empower Air Force units with innovative software solutions that optimize accommodation management processes, enhance communication, and improve the overall experience of service members and their families.</p>
            </div>
...
<!--              <div class="col-lg-3 col-md-6 icon-box" data-aos="fade-up" data-toggle="modal" data-target="#myModal_save" style="cursor: pointer;">
          ...
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200" data-toggle="modal" data-target="#myModal_gas" style="cursor: pointer;">
            ...
            <p class="" style="text-align: justify">Posting emanating from recieved signals can be matched against the Database to Identify Personnels with exiting accommodation</p>
          </div>
      ...
      <div class="container">
        ...
        <div class="row  d-flex align-items-stretch">
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up">
            ...
            <p style="text-align: justify">
              A Personnel is registered using a phone, tablet or PC. The system also identifies duplicate registration via the Service Number.  
            </p>
          </div>
        ...
        The current database can accommodate 20,000 - 25,0000 Personnel. It is upgradable to accommodate more   </p>
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="300">
            ...
            <p>
            The DataBase is encrypted with SSL (Secure Sockets Layer) to ensure safety between the website and the server.
            </p>
          </div>
       ...
       <div class="modal fade" id="myModal_gas">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
            <p>
            Posting emanating from recieved signals can be matched against the Database to Identify Personnels with exiting accommodation.
             </p>
           </div>
              <div class="modal-footer">
                <!--<button type="submit" class="btn btn-success" style="border-radius: 20px; font-size: 16px;" name="submit_course">Submit</button><br>-->
