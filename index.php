...
if (isset($_POST['Submit'])) {
  // By  Adedokun Adewale Azeez 19th October 2021
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div class="logo float-left">
        <h3 class="text-light"><a href="index.php"><span><b>
                <img src="images/1200px-Nigerian_Air_Force_emblem.svg.png" style="width: 40px;" alt=""> SEAFB
                (RDCSAC)</b></span></a></h3>
      ...
      <nav class="nav-menu float-right d-none d-lg-block" id="nav-menu">
        <ul>
          ...
          <li><a href="fin_admin.php"><b>Login</b></a></li>
          ...
          <div class="carousel-item active" style="background-image: url('assets1/img/slide/naf_slide.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                <h2 class="animate__animated animate__fadeInDown"><span> Sam Ethnan <br> Air Force Base <br> SEAFB
                    (RDCSAC)</span></h2>
                <p class="animate__animated animate__fadeInUp">Revolutionizing how the Base handles housing logistics,
                  streamlining processes for efficiency and convenience and
          ...
          <div class="carousel-item" style="background-image: url('assets1/img/slide/naf_slide2.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                ...
                <p class="animate__animated animate__fadeInUp"> A comprehensive solution for Air Force Barracks,
                  offering intuitive interfaces and robust features tailored to the unique needs of military housing
                  management as well as optimizing occupancy rates and maximizing the utilization of available housing
                  resources.
                <p>
          ...
          <div class="carousel-item" style="background-image: url('assets1/img/slide/naf_slide4.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                ...
                <p class="animate__animated animate__fadeInUp">With real-time updates and customizable features,
                  adapting to the dynamic nature of Air Force operations, ensuring accurate tracking and allocation of
                  accommodations across various bases and deployments to improve communication, and enhance the quality
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center about-content">
            ...
            <div class="section-title">
              <h2>About Us</h2>
              <p style="text-align: justify">At SEAFB (RDCSAC), we are dedicated to providing cutting-edge solutions for
                accommodation management in Air Force Barracks. With a team of passionate professionals, we strive to
                revolutionize the way military housing logistics are handled, ensuring efficiency, transparency, and
                ease of use for Air Force personnel and their families. Our innovative software is designed with the
                unique needs of the military in mind, offering intuitive interfaces and unparalleled support to enhance
                the quality of life and readiness of our service members.</p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="bx bx-fingerprint"></i></div>
              <h4 class="title"><a href="">Mission</a></h4>
              <p class="description">Our mission is to empower Air Force units with innovative software solutions that
                optimize accommodation management processes, enhance communication, and improve the overall experience
                of service members and their families.</p>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
              <div class="modal-content">
                ...
                <form name="reg_loan" action="index.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="modal-body">
                    <center class="row">
                      ...
                      <div width="140" height="140" class="mb-2 col-sm-6">
                        <img id="img123" src="#" alt="CLICK 'BROWSE' TO UPLOAD PHOTO"
                          style="border: 4px #99ff99 solid; width:140px; height:140px;">

                        <div class="custom-file mb-3" style="width: 200px;">
                          <input type="file" class="custom-file-input" id="customFile" required="" name="fileToUpload"
                            accept="image/*">
                      ...
                      <div class="col-sm-6 mb-5" style="margin-right:  0px;">
                        <input type="file" name="fileToUpload1" accept="image/*" name="image" id="file1" required=""
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="enter Name" name="name" id="autocomplete"
                          class="getname" maxlength="50" style="text-transform: uppercase;" required>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="enter Occupation" type="text" name="parent"
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <input class="form-control" type="number" placeholder="enter phone_number" name="telephone"
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" onfocus="this.type='date'" class="form-control" name="dateofbirth"
                          placeholder="Click here select date form calender icon" style="border-radius: 5px;"
                          required="">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <input class="form-control" type="text" onkeypress="return CheckNumeric()"
                          onkeyup="FormatCurrency(this)" placeholder="enter amount" name="prop_amt" maxlength="12"
                          required>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <input class="form-control" type="text" name="religion" required="" maxlength="50"
                          placeholder="enter Refree 1 name and phone number" maxlength="50">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" type="text" name="loginid"
                          placeholder="enter Refree 2 name and phone number" maxlength="50">
                      </div>
                    </div>
                  ...
                  <hr>
                  <center><button style=" width: 50%; font-weight: bolder; font-size: 20px;" type="submit" name="Submit"
                      id="check_duplicate" class="btn btn-success">Submit</button></center>
                  <br>
                  <!-- Modal footer -->
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100" data-toggle="modal"
            data-target="#myModal_estate" style="cursor: pointer;">
            <div class="icon"><i class="icofont-user-alt-3"></i></div>
            <h4 class="title">Personnel Registration</h4>
            <p class="" style="text-align: justify"> Each Personnel will be captured digitally. All required information
              will be provided as well as a facial information and dependents.</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200" data-toggle="modal"
            data-target="#myModal_gas" style="cursor: pointer;">
            <div class="icon"><i class="icofont-arrow-right"></i></div>
            <h4 class="title">Posting Identification</h4>
            <p class="" style="text-align: justify">Posting emanating from recieved signals can be matched against the
              Database to Identify Personnels with exiting accommodation</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300" data-toggle="modal"
            data-target="#myModal_invest" style="cursor: pointer;">
            <div class="icon"><i class="icofont-chart-bar-graph"></i></div>
            <h4 class="title">Data Analytics</h4>
            <p class="" style="text-align: justify">As a result of Digital collation of all Personnels, filtering
              existing data can help in identifying certain aspects of concern.</p>
          </div>
        ...
        <div class="row  d-flex align-items-stretch">
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up">
            ...
            <p style="text-align: justify">
              A Personnel is registered using a phone, tablet or PC. The system also identifies duplicate registration
              via the Service Number.
            </p>
          </div>
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="100">
            ...
            <p style="text-align: justify">
              The system does not permit dual registration of different Personnel for a specific accommodation.
            </p>
          </div>
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="200">
            ...
            <p style="text-align: justify">
              The current database can accommodate 20,000 - 25,0000 Personnel. It is upgradable to accommodate more </p>
          </div>

          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="300">
            <h4>Are all registerd Personnel Secured ?</h4>
            <p>
              The DataBase is encrypted with SSL (Secure Sockets Layer) to ensure safety between the website and the
              server.
            </p>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="info-box">
              <i class="bx bx-map"></i>
              <h3>Our Address</h3>
              <p>SEAFB (RDCSAC), Sam Ethnan Air Force Base Ikeja, Lagos</p>
            </div>
          </div>
          ...
          <div class="modal fade" id="myModal_save">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>
                    Get any form of Loan suitable for your flexibility as well as payment capacity. We offer Daily,
                    Weekly and Monthly lending. Feel free to contact us regarding your choice of product.
                  </p>
                </div>
                <div class="modal-footer">
                  <!--<button type="submit" class="btn btn-success" style="border-radius: 20px; font-size: 16px;" name="submit_course">Submit</button><br>-->
                  <button style="margin-left: 0px;" data-dismiss="modal"
                    class="btn btn-danger float-right">Close</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal fade" id="myModal_estate">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>
                    Each Personnel will be captured digitally. All required information will be provided as well as
                    facial information and dependents.
                  </p>
                </div>
                <div class="modal-footer">
                  <!--<button type="submit" class="btn btn-success" style="border-radius: 20px; font-size: 16px;" name="submit_course">Submit</button><br>-->
          ...
          <div class="modal fade" id="myModal_gas">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>
                    Posting emanating from recieved signals can be matched against the Database to Identify Personnels
                    with exiting accommodation.
                  </p>
                </div>
                <div class="modal-footer">
                  <!--<button type="submit" class="btn btn-success" style="border-radius: 20px; font-size: 16px;" name="submit_course">Submit</button><br>-->
          ...
          <div class="modal fade" id="myModal_invest">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>
                    As a result of Digital collation of all Personnels, filtering existing data can help in identifying
                    certain aspects of concern. </p>
                </div>
                <div class="modal-footer">
                  <!--<button type="submit" class="btn btn-success" style="border-radius: 20px; font-size: 16px;" name="submit_course">Submit</button><br>-->
                  <button style="margin-left: 0px;" data-dismiss="modal"
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>SEAFB (RDCSAC)</span></strong>. All Rights Reserved
      </div>
      <!-- <div class="credits">
