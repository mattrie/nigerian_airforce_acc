...
// By  Adedokun Adewale Azeez 22nd September 2019
    $id = $_POST['idd'];
...
<head>
    <title>Edit OFFRS Registration</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Edit OFFRS Registration</h5>
                                            <p class="m-b-0">Edit OFFRS Registration</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                                        ...
                                                        <form id="myForm" action="" method="POST"
                                                            ...
                                                            <script type='text/javascript'>
                                                                $(function () {
                                                                    $(".veh_type33").autocomplete({
                                                                        ...
                                                                        select: function (event, ui) {
                                                                            $('.veh_type33').val(ui.item.label); // display the selected text
                                                                            $('#selectuser_id').val(ui.item.value); // save selected id to input
                                                                            return false;
                                                                        }
                                                                    });
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <input class="form-control" type="text"
                                                                        name="plate_no3"
                                                                        value="<?php echo $plate_no3 ?>" maxlength="70"
                                                                        placeholder="enter Vehicle 3 Plate No. here">
                                                                </div>

                                                                <div class="col-sm-5">
                                                                    <input class="form-control veh_type33" type="text"
                                                                        name="veh_type3"
                                                                        value="<?php echo $veh_type3 ?>" maxlength="70"
                                                            ...
                                                            <!-- <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    if (isset($_SESSION['id_bl'])) {
                                                                        ...
                                                                        <input class="form-control" type="text"
                                                                            name="block_leader"
                                                                            value="<?php //echo $_SESSION['bl_full_name']  ?>"
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    if (isset($_SESSION['id_bl'])) {
                                                                        ...
                                                                        <input class="form-control" type="tel"
                                                                            ...
                                                                            readonly required="" maxlength="11"
