...
if (isset($_POST['Submit'])) {
    ...
    if ($check_svn != "") {
        ...
        $sql_statement = "INSERT INTO census_registration (name, rank, gender, svn, dob, block,	unit, flat_no,	room, date_allocated, accomodation_type, marital_status, state_of_origin, phone, nod, nod_details, email, images, gender_no, block_leader, observation, leader_phone, date_reg, db_next_due1, username, password, plate_no1, veh_type1, plate_no2, veh_type2) Values('$name', '$rank','$gender', '$svn','$dob', '$block', '$unit', '$flat_no', '$room', '$date_allo', '$accomodation_type', '$marital_status', '$state_of_origin', '$phone', '$nod', '$nod_details', '$email', '$target_file12', '$gender_no', '$block_leader', '$observation', '$leader_phone', '$date', '$db_next_due1', '$username', '$pass', '$plate_no1', '$veh_type1', '$plate_no2', '$veh_type2')";
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">AIRMEN / AIRWOMEN DATA FORM</h5>
                                            <p class="m-b-0">AIRMEN / AIRWOMEN Registration</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>AIRMEN / AIRWOMEN DATA FORM</h5>
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form action="" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <!-- <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input  class="form-control"   type="email" name="email"  maxlength="50"  placeholder="enter Email here" >
                                                                </div>
                                                            </div> -->
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                        name="block_leader" id="block_leader"
                                                                        maxlength="50" placeholder="Block Leader">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <!-- <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="tel"
                                                                        name="leader_phone" id="leader_phone"
                                                                        maxlength="11"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 mx-auto">
                                                                    ...
                                                                    <a style="margin-left:70px;" class="btn btn-dark"
                                                                        href="air_men_members.php">Clear All</a>
                                                                </div>
