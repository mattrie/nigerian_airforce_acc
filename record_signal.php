                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">RECORD SIGNAL</h5>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <form  action="" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <center>
                                                        <h4 class="float-left">Record Signal:</h4>
                                        ...
                                        <form action="" method="POST">
                                            <div class="input-group">
                                                <input type="date" name="src_date" class="form-control" >
                                    ...
                                    if(isset($_POST['btnsrch'])){
                                        // By  Adedokun Adewale Azeez 27th Janaury 2020
                                        ...
                                        if ($flat_no == '' && $room == '') {
                                            $count_all = mysqli_query($connect, "SELECT COUNT(id) as count_all FROM  record_signal WHERE block = '$block'");
                                            while ($row = mysqli_fetch_array($count_all)) {
                                                $everbody = $row['count_all'];
                                            }
                                            $result = mysqli_query($connect, "SELECT * FROM  record_signal WHERE block = '$block'  ORDER BY id DESC");
                                       



                                        } else if ($room == ''){
                                            $count_all = mysqli_query($connect, "SELECT COUNT(id) as count_all FROM  record_signal WHERE block = '$block' AND flat_no = '$flat_no'");
                                            while ($row = mysqli_fetch_array($count_all)) {
                                                $everbody = $row['count_all'];
                                            }
                                            $result = mysqli_query($connect, "SELECT * FROM  record_signal WHERE block = '$block' AND flat_no = '$flat_no'  ORDER BY id DESC");
                                       


                                        } else if ($flat_no != '' && $room != ''){
                                            $count_all = mysqli_query($connect, "SELECT COUNT(id) as count_all FROM  record_signal WHERE block = '$block' AND flat_no = '$flat_no' AND room = '$room'");
                                            while ($row = mysqli_fetch_array($count_all)) {
                                                $everbody = $row['count_all'];
                                            }
                                            $result = mysqli_query($connect, "SELECT * FROM  record_signal WHERE block = '$block' AND flat_no = '$flat_no' AND room = '$room' ORDER BY id DESC");
                                       
                                        }
                                        


                                        echo '<input type="hidden" id="get_table_name" value=" RECORD SIGNAL: [' . $everbody . '] "';
                                        echo ' <div class="card">';
                                        echo '<div class="card-block table-border-style">';

                                        echo '<div class="table-responsive" >';
                                        echo '<CAPTION><h3 align="center" style="font-size:20px; color:black;" >RECORD SIGNAL: ' . $everbody . '</h3></CAPTION>';
                                        ...
                                        $count_all = mysqli_query($connect, "SELECT COUNT(id) as count_all FROM  record_signal");
                                        while ($row = mysqli_fetch_array($count_all)) {
                                            $everbody = $row['count_all'];
                                        }
                                        $result = mysqli_query($connect, "SELECT * FROM  record_signal  ORDER BY id DESC");
                                        ...
                                        echo '<div class="table-responsive" >';
                                        echo '<CAPTION><h3 align="center" style="font-size:20px; color:black;" >ALL RECORD SIGNAL: ' . $everbody . '</h3></CAPTION>';
                                        echo '<table class="table table-bordered table-striped   table-hover " id="myTable">';
